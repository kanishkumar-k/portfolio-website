...
const MediumBlogsSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className={`text-3xl font-bold mb-4 text-center font-['JetBrains_Mono',monospace] text-[var(--foreground)] underline underline-offset-8 section-title-variant${active ? " section-title-active" : ""}`}>Blogs</h2>
